package com.lib.showfield.ui.view.widget;
...
import com.lib.showfield.bean.gift.GiftIdentify;
...
public class RewardLayout extends LinearLayout {
    ...
    public void onDestroy() {
        ...
        removeCallbacks(taker);
        removeCallbacks(clearer);
        clearTask = null;
        takeTask = null;
        clearer = null;
        taker = null;
