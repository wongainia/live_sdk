package video.dkplayer_java.player;
...
import video.dkplayer_java.controller.BaseVideoController;
import video.dkplayer_java.controller.MediaPlayerControl;
import video.dkplayer_java.render.IRenderView;
import video.dkplayer_java.render.RenderViewFactory;
...
public class VideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    public static final int STATE_START_PRECTION = 9;//投屏状态
    public static final int STATE_START_CANCEL_PRECTION = 13;//取消投屏状态
