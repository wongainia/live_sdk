...
//        // 设置是否禁止重叠
    ...
    public void addDanmaku(String text, boolean isSelf) {
        ...
        danmaku.textSize = PlayerUtils.sp2px(getContext(), 13);
    ...
    public void addDanmakuWithDrawable() {
        ...
        // for(int i=0;i<100;i++){
        // }
        Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.dkplayer_battery_level);
...
//        danmaku.borderColor = Color.GREEN;
    ...
    private SpannableStringBuilder createSpannable(Drawable drawable) {
        ...
        CenterSpaceImageSpan span = new CenterSpaceImageSpan(drawable);//ImageSpan.ALIGN_BOTTOM);
